                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-primary" href="<?= base_url('Laporan/CetakFakturPenjualan/' . $r['no_transaksi_penjualan'] . '/' . $r['kode_pelanggan']) ?>" title="Cetak Faktur Pemesanan" target="_blank">

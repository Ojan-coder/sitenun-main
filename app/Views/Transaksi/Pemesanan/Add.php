                                ...
                                <div class="card card-outline card-success">
                                    ...
                                    <div class="card-body">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control kodeproduk" name="kodeproduk" id="kodeproduk">
                                                    <input type="text" class="form-control" id="namaproduk">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control kodemotif" name="kodemotif" id="kodemotif">
                                                    <input type="text" class="form-control namamotif" name="namamotif" id="namamotif">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control jumlah1" name="jumlah1" id="jumlah1">

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-success">
                    ...
                    <form action="<?= base_url('Pemesanan/prosesbayar') ?>" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                                ...
                                <div class="card card-outline card-success">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <td>Bayar :</td>
                                                <td colspan="5"><input type="number" class="form-control" name="bayardp" required></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="5">
                                                    ...
                                                    <?php } else { ?>
                                                        <input type="file" class="form-control" name="gambar" id="gambar" required>
                                                        <span><i>Untuk Pembayaran Ke-2 Silahkan Ke Rekening BRI : 5418 0101 2437 534 a/n Novi Putri Sesmita</i></span>
                                                    <?php } ?>
                                                </td>

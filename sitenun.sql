...
CREATE TABLE `tbl_karyawan` (
  ...
  `tgl_lahir` date DEFAULT NULL,
  `kodejenkel` varchar(5) DEFAULT NULL,
...
insert  into `tbl_karyawan`(`kodekaryawan`,`namalengkap`,`tgl_lahir`,`kodejenkel`,`alamat`,`nohp`,`created_at`,`updated_at`) values 
('USR-001','Fauzan Adli','1999-01-01','L',NULL,NULL,NULL,NULL),
('USR-002','Novi Putri Sesmita','2000-04-14','P','Sinjunjung',NULL,NULL,NULL),
('USR-003','Novi','2000-04-14','P',NULL,NULL,NULL,NULL),
('USR-04','alif','2000-01-01','L','Padang','8102381029','2023-07-21 10:31:22',NULL);
...
(14,'USR-04','alif','alif','$2y$10$0fUAlPaT09pAL9fQkl5zG.eYuAz4yPNbYv5uPeMrf.Hs0.CB9QwMC',3,'Y','2023-07-21 10:31:22',NULL);
